...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :session_key => '_trackrecord_session',
    :secret      => 'set-key-here'
  }
...
# unique prefix and running out of a dedicated subdirectory.

ActionController::CgiRequest::DEFAULT_SESSION_OPTIONS[:session_key] = 'trackrecordapp_session_id'
