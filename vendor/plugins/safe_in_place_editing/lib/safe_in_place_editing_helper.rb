...
module SafeInPlaceEditingHelper
  ...
  # "class.class_name.underscore", so may not be appropriate for unusual object
  ...
  def safe_in_place_editor_field( object, method, tag_options = {}, editor_options = {}, no_escape = false )
    ...
    if ( object.instance_of?( Symbol ) )
      ...
      object_name = object.class.class_name.underscore
    end
    ...
    return content_tag( :span, column_value, tag_options ) +
